'''
Current clamp demo using Allen Brain's model 473835796.
...
from neuron473835796 import Neuron473835796
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473835796(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473835796; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-92.1516036987)
        h.fcurrent()
